...
//		refreshAdapter();
	 ...
	 * 建立Story card儲存事件
	 */
	private DialogInterface.OnClickListener getCardSaveBtnListener(final View view) {
	...
	private List<StoryObject> getProductBacklogItemList() {
		List<StoryObject> storyList = mProductBacklogItemManager.retrieveProductBacklogAllItems(mProjectID);
		return storyList;
	}
	...
	public void run() {
		mStoryCardAdapter = new StoryCardAdapter(this, getProductBacklogItemList(), mProjectID);
