...
public class TaskDeleteThread extends BaseThread {
	private String mUrl, mProjectID, mTaskID, mStoryID;

	public TaskDeleteThread(String projectID, String taskID, String storyID) {
	...
	protected void handleWebServiceUrl() {
		...
		mUrl = WebServiceUrlMaker.getInstance().combineUrlWithProjectID("/task/delete/".concat(mTaskID).concat("/from/").concat(mStoryID));
	}
	...
	protected void handleOperation() {
		...
		try {
			...
			Log.e("IOException", "class:TaskDeleteThread" + e.toString());
			e.printStackTrace();
		} finally {
